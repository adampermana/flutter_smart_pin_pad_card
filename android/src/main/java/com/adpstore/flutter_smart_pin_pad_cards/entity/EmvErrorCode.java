...
public class EmvErrorCode {
    ...
    public static final String KERNTYPE_GPN_RID = "A000000602"; // Updated GPN RID
    public static final String KERNEL_GPN_ID = "A000000602"; // Updated correct GPN ID
    ...
    public static final int KERNTYPE_GPN = 0x15; // Added GPN kernel type constant
...
//---------------------------------------------------------------------------
    ...
    //---------------------------------------------------------------------------
    /*************************Error Code for GPN Trans*************************/
//---------------------------------------------------------------------------
    public static final int GPN_AMOUNT_EXCEEDS_LIMIT = 401; // Amount exceeds GPN contactless limit
    public static final int GPN_PIN_REQUIRED = 402; // PIN verification required
    public static final int GPN_OFFLINE_PIN_OK = 403; // Offline PIN verification successful
    public static final int GPN_OFFLINE_PIN_FAILED = 404; // Offline PIN verification failed
    public static final int GPN_CARD_AUTHENTICATION_FAILED = 405; // GPN card authentication failed
    public static final int GPN_CARD_BLOCKED = 406; // GPN card is blocked
    public static final int GPN_FALLBACK_TO_CONTACT = 407; // Fallback to contact interface
    public static final int GPN_TRANSACTION_NOT_ALLOWED = 408; // Transaction not allowed by GPN card
    ...
    // GPN specific contactless error codes
    public static final int CLSS_GPN_PIN_REQUIRED = -60;    // PIN required for GPN transaction
    public static final int CLSS_GPN_AUTH_FAILED = -61;     // GPN specific authentication failed
    public static final int CLSS_GPN_DOMESTIC_ONLY = -62;   // Card limited to domestic use only
    ...
    public static final byte CLSS_OC_OFFLINE_PIN = 0x30; // Added for GPN which may use offline PIN
    /**
    ...
    /***GPN specific tags *****/
    public static final int GPN_TAG_PROCESSING_OPTIONS = 0xDF60; // GPN processing options tag
    public static final int GPN_TAG_DOMESTIC_INDICATOR = 0xDF7C; // Domestic only indicator
}
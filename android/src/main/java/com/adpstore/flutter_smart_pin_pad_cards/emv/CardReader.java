...
import com.adpstore.flutter_smart_pin_pad_cards.emv.entity.CardData;
import com.adpstore.flutter_smart_pin_pad_cards.emv.utils.CardTimer;
...
public class CardReader implements ICardReader {
    ...
    private AidlMagCard magCard = AdpUsdkManage.getInstance().getMag();
    private AidlICCard icCard = AdpUsdkManage.getInstance().getIcc();
    private AidlRFCard rfCard = AdpUsdkManage.getInstance().getRf();
    private AidlShellMonitor aidlShellMonitor = AdpUsdkManage.getInstance().getShellMonitor();

...
import com.adpstore.flutter_smart_pin_pad_cards.emv.impl.EContactCallback;
...
public class ContactEmvProcess extends ABaseTransProcess {
    ...
    private AidlPinpad pinPad = AdpUsdkManage.getInstance().getPinpad(0);
    private AidlEmvL2 emvL2 = AdpUsdkManage.getInstance().getEmv();
    ...
    public EmvOutCome StartTransProcess() {
        ...
        try {
            ...
            if (emvRest == EmvErrorCode.EMV_OK) {
                ...
                boolean exist = AdpUsdkManage.getInstance().getIcc().isExist();

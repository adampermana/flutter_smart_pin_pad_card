package com.adpstore.flutter_smart_pin_pad_cards.emv.impl;

import android.os.RemoteException;

import com.adpstore.flutter_smart_pin_pad_cards.emv.ABaseTransProcess;
import com.adpstore.flutter_smart_pin_pad_cards.emv.AdpUsdkManage;
...
import com.adpstore.flutter_smart_pin_pad_cards.emv.entity.EmvTransPraram;
...
public class TransProcess implements IEmv {
    ...
    public void preInit(List<Combination> combinations) {
        try {
            AidlEntry entryL2 = AdpUsdkManage.getInstance().getEntry();
            int emvRest = -1;
...
//          AppClose();
    ...
    private void AppClose() {
        try {
            ...
            boolean closeRFstatus = AdpUsdkManage.getInstance().getRf().close();
            boolean closeICstatus = AdpUsdkManage.getInstance().getIcc().close();
